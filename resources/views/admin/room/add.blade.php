                        ...
                        <div class="border p-4 rounded">
                            ...
                            <form action="{{route('new.room')}}" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" name="number" id="inputEnterYourName" placeholder="Enter Room Number">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputEnterYourName" class="col-sm-3 col-form-label">Enter Room Description</label>
                                    <div class="col-sm-9">
                                        <textarea  class="form-control" name="description" id="inputEnterYourName" placeholder="Enter Room Description"></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputEnterYourName" class="col-sm-3 col-form-label">Room Assigned By</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="assignedBy" id="inputEnterYourName" placeholder="Enter Name">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <button type="submit" class="btn btn-primary px-5">Create Unit</button>
                                    </div>
                                </div>
