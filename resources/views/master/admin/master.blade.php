        ...
        <nav class="topbar-nav">
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{route('add.room')}}"><i class="bi bi-arrow-right-short"></i>Add Room</a>
                        </li>
                        <li> <a href="{{route('manage.room')}}"><i class="bi bi-arrow-right-short"></i>Manage Room</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow" href="javascript:;">
                        <div class="parent-icon"><i class="bi bi-diamond-half"></i>
                        </div>
                        <div class="menu-title">Service</div>
                    </a>
                    <ul>
                        <li> <a href="{{route('add.service')}}"><i class="bi bi-arrow-right-short"></i>Add Service</a>
                        </li>
                        <li> <a href="{{route('manage.service')}}"><i class="bi bi-arrow-right-short"></i>Manage Service</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="{{route('all.queue')}}"><i class="bi bi-arrow-right-short"></i>All Queue</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="{{route('report')}}"><i class="bi bi-arrow-right-short"></i>Report</a>
                        </li>
                    </ul>
                </li>
                <li class="">
                    ...
                    <ul>
                        <li> <a href="{{route('add.user')}}" ><i class="bi bi-arrow-right-short"></i>Create User</a></li>
                        <li> <a href="{{route('user')}}" ><i class="bi bi-arrow-right-short"></i>Manage General User</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
